package com.github.markpairdha.handwritingnumberdetectorapp;
...
public class DigitsDetector
{
    ...
    // Specify the input size :  1 x 28 x 28 x 1 (batch size x width x height x number of channels)
    ...
    private void preprocess(Bitmap bitmap) {
        ...
        for (int i = 0; i < pixels.length; ++i) {
            // Set 0 for white and 255 for black pixels , gray scaling the image.
            int pixel = pixels[i];
